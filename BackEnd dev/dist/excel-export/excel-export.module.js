...
exports.ExcelExportModule = ExcelExportModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([user_entity_1.User, user_log_entity_1.UserLog]), users_module_1.UsersModule],
        providers: [excel_export_service_1.ExcelExportService, users_service_1.UsersService],
